...
class categorycontroller extends Controller
{
    ...
    {
        $cat_data = category::where('sort_by',1)->orderBy('views','asc')->get();
        $me_data = category::where('sort_by',2)->orderBy('views','asc')->get();
    	$pa_data = category::where('sort_by',3)->orderBy('views','asc')->get();

...
*/	
	config.filebrowserBrowseUrl = "admin_asset/ckeditor/ckfinder/ckfinder.html";

	config.filebrowserImageBrowseUrl = "admin_asset/ckeditor/ckfinder/ckfinder.html?ty­pe=Images";
	
	config.filebrowserFlashBrowseUrl = "admin_asset/ckeditor/ckfinder/ckfinder.html?ty­pe=Flash";
	
	config.filebrowserUploadUrl = "admin_asset/ckeditor/ckfinder/core/connector/p­hp/connector.php?command=QuickUpload&­;type=Files";
	
	config.filebrowserImageUploadUrl = "admin_asset/ckeditor/ckfinder/core/connector/p­hp/connector.php?command=QuickUpload&­;type=Images";
	
	config.filebrowserFlashUploadUrl = "admin_asset/ckeditor/ckfinder/core/connector/p­hp/connector.php?command=QuickUpload&­;type=Flash"

			...
			<div class="box-content ">
				<fieldset>
					<div class="">
						...
						<div class="span6">
							<div class="control-group">
								...
								<div>
									<div>
									  <input name='hotline' type="text" placeholder="hotline ..." class="span12 ">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="control-group">
						...
						<div>
							<div>
							  <input name='investor' type="text" placeholder="investor ..." class="span12 ">
							</div>
						</div>
					</div>
					<div class="">
						<div class="control-group span6">
							...
							<div>
								<div>
								  <input name='complete' type="text" placeholder="complete ..." class="span12 ">
								</div>
							</div>
						</div>
						<div class="control-group span6">
							...
							<div>
								<div>
								  <input name='acreage' type="text" placeholder="acreage ..." class="span12 ">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div>
							<div>
							  <input name='content6' type="text" placeholder="Ưu đãi ..." class="span12 ">
							</div>
						</div>
					</div>

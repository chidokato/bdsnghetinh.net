...
<div id="content" class="span12" style="min-height: 1000px;">
	...
	@endif
	<p><a href="admin/category/add/1"><button class="btn btn-primary"><i class="icon-plus"></i> Add</button></a></p>
	<div class="row-fluid">		
	...
	<p><a href="admin/category/add/2"><button class="btn btn-primary"><i class="icon-plus"></i> Add</button></a></p>
	<div class="row-fluid">		
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon white user"></i><span class="break"></span>Category menu</h2>
			...
			<div class="box-content">
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
				  	...
				  	<tbody>
					  	...
					  	<?php dequycategory ($me_data,0,$str='',old('parent_id')); ?>							
				  	</tbody>
			  </table>            
			</div>
		</div><!--/span-->
	...
	<p><a href="admin/category/add/3"><button class="btn btn-primary"><i class="icon-plus"></i> Add</button></a></p>
	<div class="row-fluid">		
		<div class="box span12">
			<div class="box-header" data-original-title>
			...
			<div class="box-content">
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
				  	...
				  	<tbody>
					  	...
					  	<?php dequycategory ($pa_data,0,$str='',old('parent_id')); ?>							
				  	</tbody>
			  </table>            
			</div>
		</div><!--/span-->

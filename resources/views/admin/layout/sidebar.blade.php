	...
	<div class="nav-collapse sidebar-nav">
		<ul class="nav nav-tabs nav-stacked main-menu">
      		<li @yield('dashboard') ><a href="admin/dashboard"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li> 
                  ...
                  <li @yield('video')><a href="admin/video/list"><i class="icon-play-circle"></i><span class="hidden-tablet"> Video</span></a></li>
                  ...
                  <!--li @yield('location')><a href="admin/icon/list"><i class="icon-map-marker"></i><span class="hidden-tablet">Icon</span></a></li-->

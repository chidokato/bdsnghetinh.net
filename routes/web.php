...
Route::group(['prefix'=>'admin','middleware'=>'adminlogin'],function(){
	...
	Route::group(['prefix'=>'video'],function(){
		Route::get('list','c_video@getlist');
		Route::get('add','c_video@getadd');
		Route::post('add','c_video@postadd');
		
		Route::get('edit/{id}','c_video@getedit');
		Route::post('edit/{id}','c_video@postedit');
		
		Route::get('delete/{id}','c_video@getdelete');
	});
	...
	Route::group(['prefix'=>'icon'],function(){
		Route::get('list','c_icon@getlist');

		Route::get('edit/{id}','c_icon@getedit');
		Route::post('edit/{id}','c_icon@postedit');

		Route::get('add','c_icon@getadd');
		Route::post('add','c_icon@postadd');

		Route::get('delete/{id}','c_icon@getdelete');
	});
...
Route::get('gioi-thieu','fontendcontroller@about');
